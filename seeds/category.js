...
const dbUrl = process.env.DB_URL || 'mongodb://localhost:27017/share-camp'
...
const insert = async () => {
    const category = new Category({
        title: 'Fort',
        image: {
            url: 'https://images.unsplash.com/photo-1569096610945-1a094be04c74?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1130&q=80',
            filename: 'Category/fort',
        },
        description: "A fortification is a military construction or building designed for the defense of territories in warfare, and is also used to establish rule in a region during peacetime. The term is derived from Latin fortis and facere."
    })
    await category.save()
